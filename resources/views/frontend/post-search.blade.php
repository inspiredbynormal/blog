                    ...
                    <div class="post-content">
                        <div class="post-cat">
                            <div class="post-cat-list">
                                <a class="hover-flip-item-wrapper" href="{{route('front.posts-by-category', $post->category_slug)}}">
                                    <span class="hover-flip-item">
                                        <span data-text="{{$post->category_name}}">{{$post->category_name}}</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="content">
                                    <h6 class="post-author-name">
                                        <a class="hover-flip-item-wrapper" href="#">
                                            <span class="hover-flip-item">
                                                <span data-text="{{$post->name}}">{{$post->name}}</span>
                                            </span>
                                        </a>
                                    </h6>
